package mai.project.news_app.presentation.onboarding.components
...
import mai.project.news_app.presentation.onboarding.Page
import mai.project.news_app.presentation.onboarding.pages
...
fun OnBoardingPagePreview() {
    NewsAppTheme {
        Surface { OnBoardingPage(page = pages.first()) }
    }
}